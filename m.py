...
bot = telebot.TeleBot('6553640774:AAHEdBBrYD7fRq8rxYTc_-Dplr1cCobnUKU')
...
def welcome_start(message):
    ...
    response = f'''ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴘʀᴇᴍɪᴜᴍ ᴅᴅᴏs ʙᴏᴛ, {user_name}! ᴛʜɪs ɪs ʜɪɢʜ ǫᴜᴀʟɪᴛʏ sᴇʀᴠᴇʀ ʙᴀsᴇᴅ ᴅᴅᴏs. ᴛᴏ ɢᴇᴛ ᴀᴄᴄᴇss.Try To Run This Command : /help'''
    bot.reply_to(message, response)
